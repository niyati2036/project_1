...
from src.project_1.utils import save_object, evaluate_models
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        ...
        try:
            ...
            logging.info("Defining machine learning models")
            ...
            logging.info("Setting hyperparameter grids")
            ...
            logging.info("Evaluating models using evaluate_models function")
            ...
            logging.info("Saving best model to artifacts folder")
